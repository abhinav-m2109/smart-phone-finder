      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          <div style={{ fontSize: '0.82rem', color: 'var(--text-muted)' }}>
            Compare prices & buy directly on Amazon India, Flipkart, Croma, Reliance Digital & Official Stores
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          {phone.stores?.map((store, index) => {
            const directLink = store.link || getStoreLink(store.name, phone.name);
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  >
                    <span>Buy on {store.name.split(' ')[0]}</span>
